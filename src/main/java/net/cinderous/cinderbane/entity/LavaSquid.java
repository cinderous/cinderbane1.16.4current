...
public class LavaSquid extends WaterMobEntity {
    ...
    public LavaSquid(EntityType<? extends LavaSquid> type, World worldIn) {
        super(type, worldIn);
    ...
    public static boolean func_223365_b(EntityType<LavaSquid> p_223365_0_, IWorld p_223365_1_, SpawnReason reason, BlockPos p_223365_3_, Random p_223365_4_) {
    ...
    class FleeGoal extends Goal {
        ...
        public boolean shouldExecute() {
            LivingEntity livingentity = LavaSquid.this.getRevengeTarget();
            if (LavaSquid.this.isInWater() && livingentity != null) {
                return LavaSquid.this.getDistanceSq(livingentity) < 100.0D;
            } else {
                return false;
            }
        }
        ...
        public void tick() {
            ...
            if (livingentity != null) {
                Vector3d vector3d = new Vector3d(LavaSquid.this.getPosX() - livingentity.getPosX(), LavaSquid.this.getPosY() - livingentity.getPosY(), LavaSquid.this.getPosZ() - livingentity.getPosZ());
                BlockState blockstate = LavaSquid.this.world.getBlockState(new BlockPos(LavaSquid.this.getPosX() + vector3d.x, LavaSquid.this.getPosY() + vector3d.y, LavaSquid.this.getPosZ() + vector3d.z));
                FluidState fluidstate = LavaSquid.this.world.getFluidState(new BlockPos(LavaSquid.this.getPosX() + vector3d.x, LavaSquid.this.getPosY() + vector3d.y, LavaSquid.this.getPosZ() + vector3d.z));
                if (fluidstate.isTagged(FluidTags.WATER) || blockstate.isAir()) {
                    ...
                    LavaSquid.this.setMovementVector((float)vector3d.x / 20.0F, (float)vector3d.y / 20.0F, (float)vector3d.z / 20.0F);
                }

                if (this.tickCounter % 10 == 5) {
                    LavaSquid.this.world.addParticle(ParticleTypes.BUBBLE, LavaSquid.this.getPosX(), LavaSquid.this.getPosY(), LavaSquid.this.getPosZ(), 0.0D, 0.0D, 0.0D);
                }
    ...
    class MoveRandomGoal extends Goal {
        ...
        public MoveRandomGoal(LavaSquid p_i48823_2_) {
